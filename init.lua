...
-- Window resizing
vim.keymap.set('n', '<leader><Up>', '<C-w>+', { desc = 'Resize window vertically up' })
vim.keymap.set('n', '<leader><Down>', '<C-w>-', { desc = 'Resize window vertically down' })
vim.keymap.set('n', '<leader><Left>', '<C-w><', { desc = 'Resize window vertically left' })
vim.keymap.set('n', '<leader><Right>', '<C-w>>', { desc = 'Resize window vertically right' })
